...
import com.wighawag.ui.layout.LinearLayout;
import com.wighawag.ui.layout.VerticalLayout;
import haxe.Json;
import com.wighawag.ui.element.Button;
import com.wighawag.ui.layout.AbsoluteLayout;
...
class BasicGenericUI<UIAssetProvider : BasicUIAssetProvider> {
    ...
    private var elements : Hash<UIElement>;
    private var styles : Hash<Dynamic>;
    ...
    private function parseStyle(style : String) : Hash<Dynamic>{
    ...
    private function parseElement(xmlElement : Fast, elements : Hash<UIElement>) : LayoutChild<Dynamic>{
